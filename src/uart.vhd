--------------------------------------------------------------------------------
--	 https://www.digikey.com/eewiki/pages/viewpage.action?pageId=59507062
--
--   FileName:         uart.vhd
--   Dependencies:     none
...
--
--   Version History
--   Version 1.0 26/5/2017 Scott Larson
--   	Initial Public Release
--	 Modified 12/5/2019 Narottam Royal
--		Switched reset to active high
--    
--------------------------------------------------------------------------------
...
ENTITY uart IS
	GENERIC(
		clk_freq	: INTEGER	   := 100000000;									--frequency of system clock in Hertz
